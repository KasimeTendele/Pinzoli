...
<section class="deces">
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <form class="d-flex mt-3 flex-wrap" role="search" method="GET" action="">
            ...
            <div class="container">
            <div class=" py-5 px-4 d-sm-flex align-items-center flex-wrap gap-2">
        @forelse($defunts as $defunt)
            <div class=" mr-2 ml-1 swiper-slide "  style="width: 20rem;">
                <!-- Profile widget -->
                <div class="bg-white shadow rounded overflow-hidden">
                    ...
                    <div class="card-body mt-5 pb-3 pl-2 pt-4 pl-4">
                        ...
                        <p class="card-text" style="height: 35px;">{{ Str::words( $defunt->commentaire,10) }}</p>
    ...
    <div>
        <div class="row">
            ...
            <div class="col-sm-4">
                <h3 class="text text-end">Vous avez vu <span>{{count($defunts)}}</span>   @if(count($defunts)>1) {{'defunts'}} @else{{'defunt'}} @endif </h3>
            </div>
        </div>
    </div>
{{$defunts->links()}}
